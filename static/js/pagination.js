document.addEventListener('DOMContentLoaded', function() {
    const entries = [
        ...
        { date: 'June 2024', description: 'Teaching Assistant for CSCI P-14115 "Introduction to Data Science" at Harvard Summer School', label: 'milestone' },
        ...
        { date: 'Feb 2024', description: 'Research Assistant at the Harvard Berkman Klein Center', label: 'research' },
        ...
        { date: 'Sep 2023', description: "Course Assistant for Harvard COMPSCI 171 'Visualization' (x2) ", label: 'milestone' },
        { date: 'Aug 2023', description: "Attended SIGGRAPH 2023 in Los Angeles, California", label: 'award' },
        { date: 'June 2023', description: "SURF Fellowship with Caltech's Data to Discovery Group", label: 'research' },
        { date: 'Feb 2023', description: 'Study abroad in Computer Science at AIT Budapest in Hungary', label: 'milestone' },
        { date: 'Jan 2023', description: 'Taught a data storytelling workshop in 5 NYC public schools', label: 'milestone' },
        { date: 'Sep 2022', description: "Course Assistant for Harvard COMPSCI 171 'Visualization' ", label: 'milestone' },
        { date: 'Sep 2022', description: "Conducted research through the Harvard Computer Science Department", label: 'research' },
        { date: 'June 2022', description: "PRISE Fellowship with the Harvard Data Science Initiative", label: 'research' },
        { date: 'May 2022', description: "Attended EAGxPrague in Prague, Czechia", label: 'award' },
        { date: 'Feb 2022', description: "Conducted research through the Harvard Government Department", label: 'research' },
        ...
        { date: 'June 2021', description: "Mindich PCER Fellowship with Interboro Partners", label: 'research' },
        ...
        { date: 'June 2019', description: "NASA SEES internship at the UT Center for Space Research", label: 'research' }
    ];
